...
const PLATFORM_ADMIN_CONFIG: DashboardConfig = {
  ...
  navItems: [
    ...
    // Role & permission management
    {
      label: 'Roles',
      icon: 'roles',
      route: '/platform/roles/roles-list',
      ...
      children: [
        {
          ...
          icon: '',
          route: '/cooperative/profile',
          permissions: ['organisation.view'],
        },
        {
          label: 'Branches',
          icon: '',
          route: '/cooperative/branches',
          permissions: ['branches.view'],
        },
        {
          label: 'Collection Hubs',
          icon: '',
          route: '/cooperative/collection-hubs',
          permissions: ['collection_hubs.view'],
        },
      ],
    },
      ...
      children: [
        {
          label: 'Grade Config',
          icon: '',
          route: '/cooperative/grade-config',
          permissions: ['configuration.grades.view'],
        },
        {
          label: 'Edit Prices',
          icon: '',
          route: '/cooperative/edit-prices',
          permissions: ['configuration.prices.view', 'configuration.prices.edit'],
        },
        {
          label: 'Sessions',
          icon: '',
          route: '/cooperative/sessions',
          permissions: ['configuration.sessions.view', 'configuration.sessions.edit'],
        },
      ],
    },
      ...
      children: [
        {
          label: 'Current Stock',
          icon: '',
          route: '/cooperative/inventory/current-stock',
          permissions: ['inventory.view'],
        },
        {
          label: 'Issue Stock',
          icon: '',
          route: '/cooperative/inventory/issue-stock',
          permissions: ['inventory.issue'],
        },
        {
          label: 'Stock-disbursed',
          icon: '',
          route: '/cooperative/inventory/stock-disbursed',
          permissions: ['inventory.disburse'],
        },
      ],
    },
    ...
    // Finance — payment batches and batch overview
    {
      ...
      children: [
        ...
        },
        {
          ...
          icon: '',
          route: '/cooperative/finance/payment-batches',
          permissions: ['finance.view'],
        },
      ],
    },
      ...
      children: [
        {
          ...
          icon: '',
          route: '/branch/finance/batch-processing',
          permissions: ['finance.view', 'finance.batches.create'],
        },
        {
          label: 'Batch Farmers',
          icon: '',
    ...
    // Inventory is a collapsible parent — clicking it reveals current stock, issue stock and stock disbursed
    {
      ...
      children: [
        ...
        },
        {
          label: 'Issue Input',
          icon: '',
          route: '/branch/inventory/issue-input',
          permissions: ['inventory.issue'],
        },
        {
          label: 'Stock-disbursed',
          icon: '',
          route: '/branch/inventory/stock-disbursed',
          permissions: ['inventory.disburse'],
        },
        {
          label: 'Request Stock',
          icon: '',
          route: '/branch/inventory/request-stock',
...
export class DashboardConfigService {
  ...
  getConfig(level: UserLevel): DashboardConfig {
    switch (level) {
      case 'platform':
        return PLATFORM_ADMIN_CONFIG;
      case 'cooperative':
        return COOPERATIVE_ADMIN_CONFIG;
      case 'branch':
  ...
  levelForRole(role: string | null): UserLevel {
    switch ((role ?? '').toUpperCase()) {
      ...
      case 'COOPERATIVE_ADMIN_CHECKER':
        return 'cooperative';
      case 'BRANCH_MANAGER':
      case 'BRANCH':
        return 'branch';
